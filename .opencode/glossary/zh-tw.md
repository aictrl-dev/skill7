...
- PR #13942: https://github.com/anomalyco/aictrl/pull/13942

## Do Not Translate (Locale Additions)

- `Aictrl` (preserve casing in prose; keep `aictrl` only when it is part of commands, package names, paths, or code)
- `Aictrl Zen`
- `Aictrl CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `aictrl` in prose when referring to the product name; use `Aictrl`
