...
- PR #10809: https://github.com/anomalyco/aictrl/pull/10809
- PR #11496: https://github.com/anomalyco/aictrl/pull/11496

## Do Not Translate (Locale Additions)

- `Aictrl` (preserve casing in prose; keep `aictrl` only in commands, package names, paths, or code)
- `Aictrl CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
