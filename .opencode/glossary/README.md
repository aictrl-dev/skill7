...
Use this folder for locale-specific translation guidance that supplements `.aictrl/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/aictrl/pull/12345

## Do Not Translate (Locale Additions)

- `Aictrl` (preserve casing)
