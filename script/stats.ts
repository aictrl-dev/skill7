...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/aictrl/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/aictrl...\n")
...
console.log("Fetching npm all-time downloads for @aictrl/cli...\n")
const npmDownloads = await fetchNpmDownloads("@aictrl/cli")
