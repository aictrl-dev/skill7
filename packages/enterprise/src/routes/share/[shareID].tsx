import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@skill7-ai/sdk/v2"
import { SessionTurn } from "@skill7-ai/ui/session-turn"
import { SessionReview } from "@skill7-ai/ui/session-review"
import { DataProvider } from "@skill7-ai/ui/context"
import { FileComponentProvider } from "@skill7-ai/ui/context/file"
import { WorkerPoolProvider } from "@skill7-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@skill7-ai/ui/logo"
import { IconButton } from "@skill7-ai/ui/icon-button"
import { ProviderIcon } from "@skill7-ai/ui/provider-icon"
import { createDefaultOptions } from "@skill7-ai/ui/pierre"
import { iife } from "@skill7-ai/util/iife"
import { Binary } from "@skill7-ai/util/binary"
import { NamedError } from "@skill7-ai/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@skill7-ai/ui/tabs"
import { MessageNav } from "@skill7-ai/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { FileSSR } from "@skill7-ai/ui/file-ssr"
import { clientOnly } from "@solidjs/start"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@skill7-ai/ui/pierre/worker").then((m) => ({
