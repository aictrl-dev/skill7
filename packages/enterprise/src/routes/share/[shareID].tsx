import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@aictrl/sdk/v2"
import { SessionTurn } from "@aictrl/ui/session-turn"
import { SessionReview } from "@aictrl/ui/session-review"
import { DataProvider } from "@aictrl/ui/context"
import { FileComponentProvider } from "@aictrl/ui/context/file"
import { WorkerPoolProvider } from "@aictrl/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@aictrl/ui/logo"
import { IconButton } from "@aictrl/ui/icon-button"
import { ProviderIcon } from "@aictrl/ui/provider-icon"
import { createDefaultOptions } from "@aictrl/ui/pierre"
import { iife } from "@aictrl/util/iife"
import { Binary } from "@aictrl/util/binary"
import { NamedError } from "@aictrl/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@aictrl/ui/tabs"
import { MessageNav } from "@aictrl/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { FileSSR } from "@aictrl/ui/file-ssr"
import { clientOnly } from "@solidjs/start"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@aictrl/ui/pierre/worker").then((m) => ({
