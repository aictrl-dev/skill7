...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AICTRL_CALLER", () => {
    process.env["AICTRL_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AICTRL_CALLER", () => {
    process.env["AICTRL_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AICTRL_CALLER", () => {
    process.env["AICTRL_CALLER"] = "unknown"
