...
/**
 * Server configuration for skill7 serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: skill7.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  /**
   * Agent configuration, see https://skill7.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
